...
df = pd.concat([df, df_ma5 , df_diff1 , df_diff1_abs], axis=1) # Add the generated features to the dataset.
#df_abs,df_abs_ma5,df_lag1,df_vol5,df_diff21,df_diff21_abs, df_diff63,df_diff63_abs,
